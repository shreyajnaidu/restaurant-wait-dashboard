  ...
  return (
    <div 
      className={`
        ...
        ${isFree 
          ? 'bg-emerald-500/10 border-emerald-500/40 hover:border-emerald-300 hover:scale-105 glow-green' 
          : 'wood-card hover:scale-105 glow-red'
        }
      `}
    >
      {/* Top Right Indicator */}
      <div className="absolute top-4 right-4">
        <span className={`
          ...
          ${isFree ? 'bg-emerald-400' : 'bg-red-400'}
        `}>
          {isFree && (
      ...
      <div className="flex flex-col items-start">
        ...
        <span className={`text-2xl font-bold mt-1 ${isFree ? 'text-emerald-300' : 'text-amber-200'}`}>
